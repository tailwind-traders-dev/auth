...
The [GitHub repo for this template is here](https://github.com/robconery/auth). I don't have discussions enabled, but feel free to pop an issue if you like or, better yet, a PR!
